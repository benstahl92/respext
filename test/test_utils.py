...
def test_load_spectrum():
	wave, flux = utils.load_spectrum(Ia_SPEC_FILE, normalize = False)
...
def test_load_spectrum_median():
	wave, flux = utils.load_spectrum(Ia_SPEC_FILE, norm_method = 'median')
...
def test_load_spectrum_badnorm():
	with warnings.catch_warnings(record = True) as w:
		...
		wave, flux = utils.load_spectrum(Ia_SPEC_FILE, norm_method = 'UNSUPPORTED MODE')
